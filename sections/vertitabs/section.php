...
/*
	...
	Description: An easy way to create and configure several vertical tabs sections at once.
	Class Name: VertiTabs
	Filter: component
	Loading: active
*/


class VertiTabs extends PageLinesSection {

	var $default_limit = 4;

	function section_styles(){
		wp_enqueue_script('vertitabs',  $this->base_url.'/vertitabs.js');
		wp_enqueue_style( 'vertitabs-css', $this->base_url.'/vertitabs.css');
	}
		...
		$(function() {  
		  ...
		  $('ul.tabs').delegate('li:not(.current)', 'click', function() {  
		   $(this).addClass('current').siblings().removeClass('current')  
		    .parents('div.section').find('div.box').eq($(this).index()).fadeIn(1500).siblings('div.box').hide();  
		  })  
